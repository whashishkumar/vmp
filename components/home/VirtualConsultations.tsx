...
const VirtualConsultations = ({ virtualSection }: any) => {
  const { heading, checklist, buttons, image } = virtualSection || {};
      ...
      <div className="inner-wrapper mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center py-16 lg:px-0 px-6">
        <div className="space-y-8">
          <div className="space-y-4">
            ...
            <p className="text-lg text-black leading-relaxed l">{heading.description}</p>
          </div>
