...
export default function PartnerNetworkSection({ data }: any) {
  return (
    <section className="relative overflow-hidden py-16 bg-white text-black">
      <div className="relative wrapper mx-auto text-center px-4">
        <div
          className={`inline-flex px-4 py-1.5 rounded-full bg-[#0d542b] text-white text-sm font-medium mb-6 onest`}
        >
          {data.badge}
        </div>
        ...
        {/* Network Hub: Light gray background with border */}
        <div className="max-w-4xl mx-auto rounded-3xl bg-gray-50 border border-gray-100 p-12 mb-14 relative shadow-sm">
          <div className="flex flex-col md:flex-row justify-between items-center gap-8 md:gap-0">
            <div className="text-center z-10">
              ...
              <p className="font-bold text-slate-900">{data.hub.left.title}</p>
            ...
            <div className="text-center relative z-10">
              ...
              <p className="font-bold text-xl text-slate-900">{data.hub.center.title}</p>
