    ...
    <section className="py-16 bg-white">
      <div className="inner-wrapper m-auto px-6 lg:px-0">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-500 max-w-2xl mx-auto onest">{comparisonData.description}</p>
        </div>
        {/* Cards */}
        <div className="grid md:grid-cols-2 gap-8">
          <div className="relative bg-white border border-gray-200 rounded-3xl p-10">
            ...
            <h3 className="text-2xl font-semibold text-black mb-6 bicroLage">
              {comparisonData.Recommended.title}
            </h3>

            <ul className="space-y-4">
              {comparisonData.Recommended.points.map((p: any, i: number) => (
          ...
          <div className="relative bg-linear-to-br from-[#006134] to-[#006d3a] text-white rounded-3xl p-10 shadow-xl">
            ...
            <ul className="space-y-4">
              {comparisonData.Traditional.points.map((p: any, i: number) => (
