...
export default async function page() {
  const resp = await ServicesPageEndPoint.getVmpMarketing();
  const { about, web, hero, marketing, tech } = resp || {};

  return (
    <div>
      <InnerBanner bannerInfo={hero} className="bg-color" />
      <HeroSection data={about} />
      <VetWebDesignSection vetWebData={web} />
      <VetMarketingSection marketingData={marketing} />
      <TechServicesSection techData={tech} />
    </div>
  );
}
