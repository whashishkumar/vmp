...
export default function page() {
  return (
    <div>
      ...
      <PetManagementSection petMgmtData={petMgmtData} />
      <AppointmentSection appointmentData={appointmentData} />
      <SmartChatSection chatData={chatData} />
      <HealthInsightsSection healthData={healthData} />
      <MedicalRecordsSection medicalData={medicalData} />
      <WhyLoveSection whyLoveData={whyLoveData} />
    </div>
  );
}
